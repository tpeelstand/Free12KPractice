    <h3 class="nav-title">English Grade Levels</h3>
    <ul class="edu-nav-list">
        ...
        foreach ($english_grades as $english_grade) {
            ?>
            <li class="nav-item" data-subject="<?php echo esc_attr($english_grade->slug); ?>" data-term-id="<?php echo esc_attr($english_grade->term_id); ?>" data-show-domains="true">
                <a href="#" class="nav-link" >
                    <?php if (!empty($english_grade->description)) : ?>
                        <span class="nav-desc"><?php echo esc_html($english_grade->description); ?></span>
                    <?php endif; ?>
                </a>
            </li>
            <?php
